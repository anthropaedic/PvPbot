...
public class FacebookCompatibleReactions 
{
	private final EnumMap<FacebookReaction, List<String>> reactionMap;
	private final HashMap<String, FacebookReaction> characterMap;
	...
	public FacebookCompatibleReactions() 
	{
	...
	public FacebookReaction getFacebookReaction(String unicodeCharacter) {
		return characterMap.get(unicodeCharacter);
	}
	
	public List<String> getUnicodeCharacter(FacebookReaction reaction) {
	...
	private void addListToReaction(FacebookReaction reaction, List<String> reactionList)
	{
		reactionMap.put(reaction, reactionList);
	}
	
	private void populateCharacterMapFromReactionList(FacebookReaction reaction, List<String> reactionList) 
	{
	...
	private void populateMaps(FacebookReaction reaction, List<String> reactionList) 
	{
